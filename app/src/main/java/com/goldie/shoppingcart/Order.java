...
//         * will be created for the product, Otherwise the function adds to the amount and price to an existing product.
//         * @param productName Name of the product.
//         * @param price The price of the product
//         */
//        public void FillProductInArrayList(String productName, double price) {
...
//            }
//            if (!isFound) {
//                productOrder product = new productOrder(productName, 1, price);
